...
contract CToken is CTokenInterface, Exponential, TokenErrorReporter {
    ...
    event Log(string msg, address addr);
    ...
    Exponential
{
    ...
    function mintAllowed(
        ...
        emit Log("mintAllowed Address this", address(this));
        emit Log("mintAllowed Address cToken", cToken);

        // Shh - currently unused
        minter;
        mintAmount;

        if (markets[cToken].isListed == false) {
            emit Log("mintAllowed is not listed", cToken);
